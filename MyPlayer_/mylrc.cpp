    ...
    QLabel(parent)
{
    ...
    linear_gradient.setColorAt(0.1, QColor(42, 42, 42));
    linear_gradient.setColorAt(0.9, QColor(145, 145, 145));

    // 遮罩的线性渐变填充
    mask_linear_gradient.setStart(0, 10);
    mask_linear_gradient.setFinalStop(0, 40);
    mask_linear_gradient.setColorAt(0.1, QColor(241, 101, 40));
    mask_linear_gradient.setColorAt(0.9, QColor(145, 61, 24));
